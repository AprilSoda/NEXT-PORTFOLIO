...
const Arrow = () => {
  ...
  const getArrowClass = () => {
    if (showArrow === 'show') return 'arrow-show';
    if (showArrow === 'bottom') return 'arrow-bottom';
    return '';
  };
